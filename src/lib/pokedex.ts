...
export const GENERATION_RANGES: Record<number, { start: number; end: number; label: string }> = {
  1: { start: 1, end: 151, label: "Geração 1 — Kanto (#1–151)" },
  2: { start: 152, end: 251, label: "Geração 2 — Johto (#152–251)" },
  3: { start: 252, end: 386, label: "Geração 3 — Hoenn (#252–386)" },
  4: { start: 387, end: 493, label: "Geração 4 — Sinnoh (#387–493)" },
  5: { start: 494, end: 649, label: "Geração 5 — Unova (#494–649)" },
  6: { start: 650, end: 721, label: "Geração 6 — Kalos (#650–721)" },
  7: { start: 722, end: 809, label: "Geração 7 — Alola (#722–809)" },
  8: { start: 810, end: 905, label: "Geração 8 — Galar (#810–905)" },
  9: { start: 906, end: 1025, label: "Geração 9 — Paldea (#906–1025)" },
};

export function pokedexRange(generation: number): PokedexEntry[] {
